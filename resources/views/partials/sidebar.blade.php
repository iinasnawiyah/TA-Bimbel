                    ...
                    @if (Auth::user()->role == 'admin')
                        <li>
                            <a href="{{ route('dashboardadmin') }}"
                                class="dropdown-toggle no-arrow {{ Request::segment(2) == 'dashboard' ? 'active' : '' }}">
                        ...
                        <li>
                            <a href="{{ route('pengajar.index') }}"
                                class="dropdown-toggle no-arrow {{ Request::segment(2) == 'pengajar' ? 'active' : '' }}">
                        ...
                        <li>
                            <a href="{{ route('siswa.index') }}"
                                class="dropdown-toggle no-arrow {{ Request::segment(2) == 'siswa' ? 'active' : '' }}">
                        ...
                        <li>
                            <a href="{{ route('kelas.index') }}"
                                class="dropdown-toggle no-arrow {{ Request::segment(2) == 'kelas' ? 'active' : '' }}">
                                <span class="fa fa-gear"></span><span class="mtext">Kelola Kategori Kelas</span>
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('kelpaket.index') }}"
                                class="dropdown-toggle no-arrow {{ Request::segment(2) == 'kelpaket' ? 'active' : '' }}">
                                <span class="fa fa-gear"></span><span class="mtext">Kelola Paket</span>
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('kelRiwayatPaket') }}"
                                class="dropdown-toggle no-arrow {{ Request::segment(2) == 'kelRiwayatPaket' || Request::segment(2) == 'kelPembayaran' || Request::segment(2) == 'kelPembayaran' ? 'active' : '' }}">
                    ...
                    @elseif(Auth::user()->role == 'pengajar')
                        ...
                        <li>
                            <a href="{{ route('dataSiswa') }}"
                                class="dropdown-toggle no-arrow {{ Request::segment(2) == 'datasiswa' ? 'active' : '' }}">
                                <span class="fa fa-user"></span><span class="mtext">Data Siswa</span>
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('manajemenKegiatan') }}"
                                class="dropdown-toggle no-arrow {{ Request::segment(2) == 'manajemen' ? 'active' : '' }}">
                    ...
                    @else
                        ...
                        <li>
                            <a href="{{ route('paket.index') }}"
                                class="dropdown-toggle no-arrow {{ Request::segment(2) == 'paket' ? 'active' : '' }}">
                                <span class="fa fa-gear"></span><span class="mtext">Pilih Paket</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('riwayatPaket') }}"
                                class="dropdown-toggle no-arrow {{ Request::segment(2) == 'riwayatPaket' || Request::segment(2) == 'listPembayaran' || Request::segment(2) == 'listKegiatan' ? 'active' : '' }}">
